...
<img src="img/home_header.png" alt="food" style="float: right;" >
<div class="center">
...
$(document).on('click', '.custom-btn', function() {
    ...
    fetch(this.value)
        ...
        .then(function(data){
            $('.row').remove()
            $('nav').after(product.load(data.image_url,data.title,data.recipe_id))
